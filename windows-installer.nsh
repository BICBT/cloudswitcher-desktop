...
!macro customInit
  ...
  ;create temp dir
  CreateDirectory $TEMP\cloudswitcher-desktop-setup
  ;download installer
  NSISdl::download "$VCRedistDownload" $TEMP\cloudswitcher-desktop-setup\vcppredist.exe
  ;exec installer
  ExecWait "$TEMP\cloudswitcher-desktop-setup\vcppredist.exe"
